...
###FOR GSE124226 data
ph@data[,1] = c("Control1","PCOS1","PCOS2","PCOS3","Control2","Control3","Control4","PCOS4")

# Quality COntrol Check
op = oar(mfrow = c(2,4))
for(i in 1:8){hist(data[,i],lwd =2,which ='pm',ylab='Density',xlab='Log2 Intensities',main=ph@data$sample[i])}
#Quality COntrol Histogram
color = c('green','red','red','red','green','green',
          'green','red')
...
#                 VIA LIMMA  
ph@data[ ,2] = c("control","PCOS","PCOS","PCOS","control","control","control","PCOS")
